...
class Console(tk.Tk):
    def __init__(self,udp_client,title="Server Console",geometry="350x200"):
        ...
        self.label_network_ip = tk.Label(self.frame_network_ip,text="IPアドレス: ")
        ...
        self.label_network_port_inbound = tk.Label(self.frame_network_port_inbound,text="Port(インバウンド): ")
        ...
        self.label_network_port_outbound = tk.Label(self.frame_network_port_outbound,text="Port(アウトバウンド): ")
        ...
        self.label_theta = tk.Label(self.frame_blur_theta,text="ブラー強度(rad): ")
